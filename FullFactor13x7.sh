...
python EscortFlowSim_v7.py --seed 0 -x 13 -y 7 -O 6 0 -e 8 -f FullFactorial13x7.csv -S 1600 -R 0.1 -I 20 -E 1 -T 20   # None
...
python EscortFlowSim_v7.py --seed 0 -x 13 -y 7 -O 6 0 -e 16 -f FullFactorial13x7.csv -S 1600 -R 0.1 -I 20 -E 1 -T 20   # None
...
python EscortFlowSim_v7.py --seed 0 -x 13 -y 7 -O 6 0 -e 8 -f FullFactorial13x7.csv -S 1600 -R 0.2 -I 20 -E 1 -T 20   # None
...
python EscortFlowSim_v7.py --seed 0 -x 13 -y 7 -O 6 0 -e 16 -f FullFactorial13x7.csv -S 1600 -R 0.2 -I 20 -E 1 -T 20   # None
...
python EscortFlowSim_v7.py --seed 0 -x 13 -y 7 -O 6 0 -e 8 -f FullFactorial13x7.csv -S 1600 -R 0.4 -I 20 -E 1 -T 20   # None
...
python EscortFlowSim_v7.py --seed 0 -x 13 -y 7 -O 6 0 -e 16 -f FullFactorial13x7.csv -S 1600 -R 0.4 -I 20 -E 1 -T 20   # None
