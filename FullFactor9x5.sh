...
python EscortFlowSim_v7.py --seed 0 -x 9 -y 5 -O 4 0 -e 4 -f FullFactorial9x5.csv -S 1600 -R 0.1 -I 20 -E 1 -T 20  --full # None
...
python EscortFlowSim_v7.py --seed 0 -x 9 -y 5 -O 4 0 -e 8 -f FullFactorial9x5.csv -S 1600 -R 0.1 -I 20 -E 1 -T 20   --full # None
...
python EscortFlowSim_v7.py --seed 0 -x 9 -y 5 -O 4 0 -e 4 -f FullFactorial9x5.csv -S 1600 -R 0.2 -I 20 -E 1 -T 20  --full # None
...
python EscortFlowSim_v7.py --seed 0 -x 9 -y 5 -O 4 0 -e 8 -f FullFactorial9x5.csv -S 1600 -R 0.2 -I 20 -E 1 -T 20   --full # None
...
python EscortFlowSim_v7.py --seed 0 -x 9 -y 5 -O 4 0 -e 4 -f FullFactorial9x5.csv -S 1600 -R 0.4 -I 20 -E 1 -T 20  --full  # None
...
python EscortFlowSim_v7.py --seed 0 -x 9 -y 5 -O 4 0 -e 8 -f FullFactorial9x5.csv -S 1600 -R 0.4 -I 20 -E 1 -T 20   --full # None
