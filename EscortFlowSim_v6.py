...
History:     3/12/2023, first version adapted from the load flow formulation implementation, warm start for single load
             ...
             11/3/2026 v5 - remove block/warmup/CI estimation and use number_of_requests directly, many bug fix and improvements
             16/3/2026 v6 - hybrid heuristic
...
def run_opl_model(target_positions, escort_positions):
    ...
    with open("end_of_exec_horizon.txt", "r") as f:
        s = f.readlines()
